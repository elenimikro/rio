...
public class AssignmentMapBasedVariableProvider extends VariableProvider {
	...
	public AssignmentMapBasedVariableProvider(AssignmentMap assignmentMap,
		...
		super(new AssignmentMapBasedOWLEntityProvider(assignmentMap), constraintSystem);
		...
		Variable<?> toReturn = owlObject
				.accept(new OWLObjectVisitorExAdapter<Variable<?>>() {
					...
					protected Variable<?> getDefaultReturnValue(OWLObject object) {
						boolean found = false;
						//AssignmentMap anAssignmentMap = AssignmentMapBasedVariableProvider.this.getAssignmentMap();
