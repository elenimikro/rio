...
public class AtomicDecompositionEquivalenceClassesAgglomerateAll {
	...
	public static void main(String[] args) {
		if (args.length >= 2) {
			...
			final Distance<OWLEntity> distance = new AxiomRelevanceAtomicDecompositionBasedDistanceNEW(manager.getOntologies(),
			...
			//it passes the threshold for the distance (criterion for stopping clustering)
			//In this case is 1. 
