...
public class AgglomerateAll {
	...
	private static Set<Cluster<OWLEntity>> buildClusters(
		...
		Set<Collection<? extends OWLEntity>> objects = clusteringMatrix.getObjects();
	...
	private static void save(ClusteringProximityMatrix<OWLEntity> clusteringMatrix,
			ProximityMatrix<OWLEntity> distanceMatrix,
			Collection<? extends OWLOntology> ontologies, OWLOntologyManager manager,
			File file) {
		try {
