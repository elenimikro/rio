...
public final class AbstractRankingRelevancePolicy<P> implements RelevancePolicy<P> {
	 ...
	 * @param ranking
	 */
	private AbstractRankingRelevancePolicy(AbstractRanking<P, Double> ranking) {
		if (ranking == null) {
	...
	public static <O> AbstractRankingRelevancePolicy<O> getAbstractRankingRelevancePolicy(
