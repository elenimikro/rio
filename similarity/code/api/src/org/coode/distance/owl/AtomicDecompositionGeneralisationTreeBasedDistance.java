...
public class AtomicDecompositionGeneralisationTreeBasedDistance implements
	...
	private final class AxiomRelevanceMap {
		...
		public AxiomRelevanceMap(Collection<? extends OWLAxiom> axioms,
			...
			for (OWLAxiom generalisedAxiom : generalisedAxioms) {
				//In the generalisationTreeNode we detect the potential variable replacements
	...
	private final OWLOntologyChangeListener listener = new OWLOntologyChangeListener() {
		public void ontologiesChanged(List<? extends OWLOntologyChange> changes)
				throws OWLException {
			AtomicDecompositionGeneralisationTreeBasedDistance.this.buildOntologySignature();
	...
	private AxiomRelevanceMap buildAxiomRelevanceMap() {
		...
		return new AxiomRelevanceMap(axioms, new OntologyManagerBasedOWLEntityProvider(
				this.getOntologyManger()), constraintSystem, this.atomicDecomposition);
	}
	...
	protected Set<OWLAxiom> computeAxiomsForEntity(OWLEntity owlEntity) {
		...
		return new HashSet<OWLAxiom>(this.cache.get(owlEntity));
	}
