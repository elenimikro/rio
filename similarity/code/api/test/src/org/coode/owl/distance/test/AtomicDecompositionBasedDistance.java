...
public class AtomicDecompositionBasedDistance extends DistanceTestCase {
	...
	protected DistanceBuilder getDistanceBuilder() {
		return new DistanceBuilder() {
			...
			public AbstractAxiomBasedDistance getDistance(OWLOntology o) {
				return new AxiomRelevanceAtomicDecompositionBasedDistanceNEW(o.getImportsClosure(), o
	...
	public void testMargheritaSicilianaPopularityRelevance() {
		...
		for (RankingSlot<OWLEntity, Double> s : ranking.getRanking()) {
	...
	public void testSpicinessSauceToppingAtomicDecompositionRelevance() {
		...
		OWLAtomicDecompositionMap map = new OWLAtomicDecompositionMap(o.getImportsClosure(), getOntologyManager());
		AtomicDecompositionRanking ranking = AtomicDecompositionRanking.buildRanking(o
				.getImportsClosure(), map);
	...
	public void testToyOntology() {
		...
		properTest(distance, o, classes);
		int i = 1;
		System.out.println(String.format("Average atomic decomposition dependencies %s standard deviation %f",
