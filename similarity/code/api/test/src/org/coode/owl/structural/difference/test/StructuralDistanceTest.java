...
public class StructuralDistanceTest {
	...
	@Test
	public void differentStructuralDistanceTest()
		...
		OWLObjectProperty p2 = f
				.getOWLObjectProperty(IRI.create("urn:test#p2"));
		...
		OWLSubClassOfAxiom A1Subp1someB1 = f
				.getOWLSubClassOfAxiom(a1, p1someB1);
		...
		OWLSubClassOfAxiom A2Subp1someB2 = f
				.getOWLSubClassOfAxiom(a2, p1someB2);
		OWLSubClassOfAxiom A2Subp1someC = f.getOWLSubClassOfAxiom(a2, p1someC);

		OWLSubClassOfAxiom A3Subp1someB3 = f
				.getOWLSubClassOfAxiom(a3, p1someB3);
	...
	public void testStructuralPeople() {
		OWLOntology o = OntologyTestHelper.getPeople();
		AbstractAxiomBasedDistance distance = (AbstractAxiomBasedDistance) DistanceCreator
				.createStructuralAxiomRelevanceAxiomBasedDistance(o
						.getOWLOntologyManager());
		// Collection<OWLAxiom> a1_axioms = distance.getAxioms(a1);
	...
	public void testPopularityPeople() {
		OWLOntology o = OntologyTestHelper.getPeople();
		AbstractAxiomBasedDistance distance = (AbstractAxiomBasedDistance) DistanceCreator
				.createAxiomRelevanceAxiomBasedDistance(o
						.getOWLOntologyManager());
		// Collection<OWLAxiom> a1_axioms = distance.getAxioms(a1);
		ManchesterOWLSyntaxOWLObjectRendererImpl renderer = new ManchesterOWLSyntaxOWLObjectRendererImpl();
		// ToStringRenderer.getInstance().setRenderer(
