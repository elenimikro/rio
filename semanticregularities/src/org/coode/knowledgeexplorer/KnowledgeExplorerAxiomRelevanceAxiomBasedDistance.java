...
public class KnowledgeExplorerAxiomRelevanceAxiomBasedDistance extends
	...
	private final OWLOntologyChangeListener listener = new OWLOntologyChangeListener() {
		...
		public void ontologiesChanged(
				...
				throws OWLException {
			KnowledgeExplorerAxiomRelevanceAxiomBasedDistance.this
					.buildSignature();
			KnowledgeExplorerAxiomRelevanceAxiomBasedDistance.this
					.buildAxiomEntityMap();
		}
	...
	public KnowledgeExplorerAxiomRelevanceAxiomBasedDistance(
			OWLOntology ontology, final OWLEntityReplacer replacer,
	...
	protected Set<OWLAxiom> computeAxiomsForEntity(final OWLEntity owlEntity) {
		for (OWLAxiom axiom : candidates.get(owlEntity)) {
			...
			if (generalReplacer == null) {
				generalReplacer = replacers
						.cache(axiom,
								new RelevancePolicyOWLObjectGeneralisation(
										Utils.toOWLObjectRelevancePolicy(new AxiomRelevancePolicy(
												(OWLAxiom) axiom
														.accept(replacer),
												axiomMap)), getEntityProvider()));
			}
