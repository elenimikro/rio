...
public class KnowledgeExplorerCompareDistancesTest {
    @Test
    public void testPopularityStructuralDistance() throws OWLOntologyCreationException {
        ...
        OWLClass c = o.getOWLOntologyManager().getOWLDataFactory()
                .getOWLClass(IRI.create("http://purl.obolibrary.org/obo/MAT_0000196"));
        System.out
    ...
    private void printDistance(String type, AbstractAxiomBasedDistance distance,
            OWLEntity e) {
