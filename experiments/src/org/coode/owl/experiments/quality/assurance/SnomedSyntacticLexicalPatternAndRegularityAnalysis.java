...
public class SnomedSyntacticLexicalPatternAndRegularityAnalysis {
	...
	public static void main(String[] args) {
		...
		File toSaveMetrics = new File(resultsDir
				+ "allLexicalAxiomRegularityResults.csv");
	...
	private static void runAnalysis(String resultsBase, File toSaveMetrics,
			OWLOntology onto, String lexpat)
	...
	public SnomedSyntacticLexicalPatternAndRegularityAnalysis(OWLOntology o,
