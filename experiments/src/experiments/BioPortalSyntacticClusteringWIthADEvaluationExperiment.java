                ...
                Callable<Object> task1 = new Callable<Object>() {
                    ...
                    public Object call() throws OWLOntologyCreationException,
                        ...
                        SyntacticClusteringWithADEvaluationExperiment.saveResults(
                                substring, "_popularity_", model);
                        // structural
                        distance = DistanceCreator
                                .createStructuralAxiomRelevanceAxiomBasedDistance(m);
                        model = SyntacticClusteringWithADEvaluationExperiment.run(
                                "structural", metrics, singleOut, o, distance, null);
                        SyntacticClusteringWithADEvaluationExperiment.saveResults(
                                substring, "_structural_", model);
                        // property relevance
                        ...
                        model = SyntacticClusteringWithADEvaluationExperiment.run(
                                "property", metrics, singleOut, o, distance, set);
                        SyntacticClusteringWithADEvaluationExperiment.saveResults(
                                substring, "_property_", model);
                        return null;
                    }
                };
