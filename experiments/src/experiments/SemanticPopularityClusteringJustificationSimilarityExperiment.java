...
public class SemanticPopularityClusteringJustificationSimilarityExperiment {
    ...
    public static void main(String[] args) throws FileNotFoundException,
        ...
        BufferedReader d = new BufferedReader(new FileReader(new File(ontologyList)));
        ...
        outputFile = new File(root + "bioportal-popularity-justification-allstats.csv");
    ...
    private static void runPopularitySemanticClustering(String input)
            throws OPPLException, OWLOntologyCreationException, FileNotFoundException {
        ...
        String filename = root + substring.replaceAll(".owl", "") + "-popularity.csv";
        System.out
        ...
        if (!f.exists()) {
            ...
            metrics.add(new SimpleMetric<String>("Clustering-type", "popularity"));
            ClusterDecompositionModel<OWLEntity> model = ExperimentHelper
                    .startSemanticClustering(o, entailments, distance, ke.getEntities());
            ...
            metrics.add(new SimpleMetric<Double>("TotalMeanJustificationSimilarity",
                    similarity.getTotalMeanJustificationSimilarity()));
            System.out
            ...
            singleOut.close();
            ClusteringWithADEvaluationExperimentBase.printMetrics(metrics, outputFile);
    ...
    private static void printJustificationExtendedResults(
        ...
        MultiMap<Double, OWLAxiom> map = similarity.getJustificationSimilarityValueMap();
