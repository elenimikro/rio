...
public class SemanticClustering extends ClusteringWithADEvaluationExperimentBase {
    ...
    public void runPopularitySemanticClustering(OWLOntology o, String filename)
        ...
        ClusterDecompositionModel<OWLEntity> model = run(clustering_type, out, o,
    ...
    private Collection<? extends SimpleMetric<?>> getMetrics(PrintStream singleOut,
            OWLOntology o, ClusterDecompositionModel<OWLEntity> model) {
