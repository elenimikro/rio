...
public class ClusterComparisonTest {
    ...
    public void getIntersectionTest() {
        ...
        Set<String> intersection = comparator.getIntersection(cluster, anotherCluster);
    ...
    public void getClusterSimilarityTest() {
        ClusterComparison<String> comparator = new ClusterComparison<String>();
        double similarity = comparator.getClusterSimilarity(cluster, anotherCluster);
    ...
    public void getMultipleClusterSimilarityTest() {
        ...
        methodB.add(new HashSet<String>(Arrays.asList("A", "B", "C", "D", "J", "K", "L")));
        ...
        ArrayList<String> elements = new ArrayList<String>(Arrays.asList("A", "B", "C",
                "D", "E", "F", "G", "I", "J", "K", "L"));
        ...
        double similarityAB = computeSimilarities(methodA, methodB, elements, mapA, mapB,
                "A", "B");
        assertEquals(0.67, similarityAB, 0.01);
        double similarityAC = computeSimilarities(methodA, methodC, elements, mapA, mapC,
                "A", "C");
        assertEquals(0.5, similarityAC, 0.1);
        double similarityBC = computeSimilarities(methodB, methodC, elements, mapB, mapC,
                "B", "C");
    ...
    public double computeSimilarities(List<Set<String>> methodA,
            ...
            Map<String, Integer> mapA, Map<String, Integer> mapB, String method,
        ...
        for (String s : elements) {
            ...
            if (!visitedEntities.contains(s)) {
                ...
                if (indexA != null && indexB != null) {
                    ...
                    System.out.println("Cluster similarity between cluster " + indexA
                            + " of method " + method + " and cluster " + indexB
                            + " of method " + anotherMethod + " is " + clusterSimilarity);
