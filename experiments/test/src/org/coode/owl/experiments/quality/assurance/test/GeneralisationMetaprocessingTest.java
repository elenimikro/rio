...
public class GeneralisationMetaprocessingTest {
    ...
    public void testSimpleGeneralisationMetaprocessing() {
        try {
            ...
            Set<OWLEntity> anotherCluster = new HashSet<OWLEntity>(Arrays.asList(c, d));
            OPPLFactory opplfactory = new OPPLFactory(o.getOWLOntologyManager(), o, null);
            ...
            OWLAxiom anotherGeneralised = (OWLAxiom) bSubc.accept(generalisation);
            MultiMap<OWLAxiom, OWLAxiomInstantiation> map = new MultiMap<OWLAxiom, OWLAxiomInstantiation>();
            map.put(generalised,
                    new OWLAxiomInstantiation(aSubc, generalisation.getSubstitutions()));
            map.put(anotherGeneralised,
                    new OWLAxiomInstantiation(bSubc, generalisation.getSubstitutions()));
