...
public class StructuralDistanceCharacterisationTest {
	...
	public void setUp() {
		try {
			...
			OWLObjectSomeValuesFrom p1_some_a1 = df.getOWLObjectSomeValuesFrom(
					p1, a1);
			OWLObjectSomeValuesFrom p2_some_a2 = df.getOWLObjectSomeValuesFrom(
					p2, a2);
			OWLObjectSomeValuesFrom p1_some_a2 = df.getOWLObjectSomeValuesFrom(
					p1, a2);
			OWLObjectSomeValuesFrom p2_some_a1 = df.getOWLObjectSomeValuesFrom(
					p2, a1);
			OWLObjectSomeValuesFrom p1_some_c1 = df.getOWLObjectSomeValuesFrom(
					p1, c1);
			OWLObjectSomeValuesFrom p2_some_c2 = df.getOWLObjectSomeValuesFrom(
					p2, c2);
			OWLObjectSomeValuesFrom p1_some_d1 = df.getOWLObjectSomeValuesFrom(
					p1, d1);
			...
			OWLSubClassOfAxiom dSub = createOWLSubClassOfAxiom(d,
					df.getOWLObjectIntersectionOf(p1_some_d1, p1_some_c1,
							p2_some_c2, a1, a2));
	...
	public OWLSubClassOfAxiom createOWLSubClassOfAxiom(
		...
		OWLSubClassOfAxiom axiom = df.getOWLSubClassOfAxiom(subClass,
				superClass);
		addAxiom(axiom);
		return axiom;
	}
