...
/**
 * Author: Eleni Mikroyannidi<br>
 * The University of Manchester<br>
 * Information Management Group<br>
 * </p> This is an alternative implementation of the utility class
 ...
 * Functional Syntax. </p> Note that this class is primarily intended for
 * developers who need to write test cases. Normal client code should probably
 * use an {@link org.semanticweb.owlapi.model.OWLDataFactory} for creating
 * objects.
 */
