...
public final class AbstractRankingRelevancePolicy<T> implements
		RelevancePolicy<T> {
	...
	// private final int computeSampleSize(final List<RankingSlot<OWLEntity>>
	// list) {
	// int size = 0;
	...
	public static <T> AbstractRankingRelevancePolicy<T> getAbstractRankingRelevancePolicy(
			final AbstractRanking<T> ranking) {
